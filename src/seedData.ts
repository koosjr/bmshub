...
export const seedEquip: EquipEntry[] = [
  ...
  { id: 'a436fac9-9d91-4fe2-ba3d-691be26eee38', code: 'HUM', label: 'Humidifier',                            takesNum: true  },
];

// ─── MED — order matches export ───────────────────────────────────────────────
export const seedMed: MedEntry[] = [
  { id: 'a0c8749f-ed52-4c00-afbc-a7744cf2365e', code: 'SA', label: 'Supply air',           takesNum: false },
  { id: 'd7c707fc-300e-46aa-a58a-9d31ca87e8a3', code: 'RA', label: 'Return air',           takesNum: false },
  { id: '50082aae-9e95-48b8-9e71-18042d90c845', code: 'OA', label: 'Outside air',          takesNum: false },
  { id: 'a7c15393-0e18-484e-a117-e1b6d05c3b91', code: 'EX', label: 'Exhaust air',          takesNum: false },
  { id: 'e1f7fd14-fd87-4688-b2c3-a5fb87be28b5', code: 'ZN', label: 'Zone / room',          takesNum: false },
  { id: 'c865e17a-6441-4861-914f-f7890f88df4d', code: 'CW', label: 'Chilled water',        takesNum: false },
  { id: 'e6b8c834-6d24-4878-bd92-0f2d5d51d62a', code: 'HW', label: 'Hot water',            takesNum: false },
  { id: 'f537fedc-654e-4701-98bc-5fdf04816c43', code: 'CO', label: 'Condenser water',      takesNum: false },
  { id: '12a4ede3-95c2-419d-9c74-31afff735bee', code: 'GY', label: 'Glycol circuit',       takesNum: false },
  { id: 'ed0aaa90-fc87-4dcf-b6c1-3ea03cf761bd', code: 'FA', label: 'Fan',                  takesNum: false },
  { id: 'cde3b135-a9ea-4068-bc94-0c92e1b7802a', code: 'RF', label: 'Refrigerant',          takesNum: false },
  { id: '4f69de70-7943-4238-ac31-03b7db3a3eca', code: 'RM', label: 'Room',                 takesNum: false },
  { id: 'c57dd755-88ce-48d8-a23a-a55366a55d79', code: 'SW', label: 'Supply Water',         takesNum: false },
  { id: 'b4ef0c57-1a39-4792-af05-518254679d43', code: 'RW', label: 'Return Water',         takesNum: false },
  { id: 'b83ef9c1-80ea-4f0e-8599-3b58cb5db42c', code: 'ES', label: 'Emergency Stop',       takesNum: false },
  { id: '6c3852ec-bf22-42a2-abdf-94a36d47bded', code: 'EN', label: 'Engine',               takesNum: false },
  { id: 'a5377f5d-cc86-4e9e-92a5-aa8f99c71bec', code: 'OL', label: 'Oil',                  takesNum: false },
  { id: '0987a0e7-a865-44d0-a077-73d547a17a25', code: 'WA', label: 'Water',                takesNum: false },
  { id: '52271fe2-b945-4a0f-a4be-b39a03ec85f6', code: 'EL', label: 'Electric',             takesNum: false },
  { id: 'dbefa209-66ce-4b85-9293-2719b496e57b', code: 'AL', label: 'Alarm',                takesNum: false },
  { id: '9084b164-e31a-4c9c-a783-8aeb38b39111', code: 'IL', label: 'Interlock - Hardwire', takesNum: false },
  { id: '83d0d5b6-e2a3-44d7-a7a9-a3de6e1cd069', code: 'AR', label: 'Air',                  takesNum: false },
  { id: '9797d933-aae2-451e-a3a6-66cede783ecf', code: 'FU', label: 'Fuel',                 takesNum: false },
  { id: 'bcabd65f-f9ae-4a95-abac-9c22e35fcd25', code: 'OX', label: 'Oxygen',               takesNum: false },
  { id: 'ceb64207-303e-41fc-b085-cc51c7703f07', code: 'NO', label: 'Nitrogen Oxide',       takesNum: false },
  { id: '986c7da4-2809-4f5e-99b4-cdaf9f1d3bd9', code: 'MA', label: 'Medical Air',          takesNum: false },
  { id: '1453de3d-2447-494b-b643-cab8c67e52b7', code: 'NI', label: 'Nitrogen',             takesNum: false },
  { id: '2a659682-0df6-46c6-b765-54be7f0fda07', code: 'CP', label: 'Compressor',           takesNum: false },
  { id: 'd17bab23-0857-42a1-bb96-552f21bdc7ba', code: 'EV', label: 'Expansion Valve',      takesNum: false },
  { id: 'e533511c-8ea5-4486-8066-ebb4a92c6c53', code: 'DF', label: 'Defrost',              takesNum: false },
  { id: '9d376555-87bd-43b2-9dd7-7d95c00ad248', code: 'ST', label: 'Steam',                takesNum: false },
  { id: 'b763e872-2eef-4344-b14d-c27bd1f0fa39', code: 'SP', label: 'Speed',                takesNum: false },
  { id: '9999881e-2c69-484b-9ef8-ec87dfcaa84e', code: 'AU', label: 'Auto',                 takesNum: false },
  { id: '45df687b-b8c3-4d4a-bc70-2e8d9261d80d', code: 'MN', label: 'Manual',               takesNum: false },
  { id: '4ee36581-1c0e-4e67-954d-d94d557774a9', code: 'FD', label: 'Dirty Filter',         takesNum: false },
];

// ─── QTY — order matches export ───────────────────────────────────────────────
export const seedQty: QtyEntry[] = [
  ...
  { id: 'a09ee73a-c4da-4a9a-bcca-e2a560f0db8c', code: 'ALM',  label: 'Alarm',                   ioType: 'DI' },
  ...
  { id: '247ffa0a-3757-417b-995a-8bca451d503b', code: 'PSW',  label: 'Pressure Switch',         ioType: 'DI' },
  ...
  { id: '4d21af5c-7c1a-4a57-a431-01712dee885e', code: 'SWT',  label: 'Switch',                  ioType: 'DI' },
  { id: 'b2472189-5cf4-4659-9a50-fbee899e84a3', code: 'ONO',  label: 'On Off',                  ioType: 'DO' },
  { id: '5994cbf1-21a1-4ec2-97e0-7cbc64754baf', code: 'TRP',  label: 'Trip',                    ioType: 'DI' },
];

// ─── MOD — order matches export ───────────────────────────────────────────────
...
export const seedQtyMods: Record<string, string[]> = {
  ...
  TMP:  ['', 'SP', 'HI', 'LO', 'HL', 'LL', 'T', 'M', 'B', 'IN', 'OUT'],
  STMP: ['', 'SP', 'HI', 'LO', 'HL', 'LL'],
  RTMP: ['', 'SP', 'HI', 'LO', 'HL', 'LL'],
  PRS:  ['', 'SP', 'HI', 'LO', 'HL', 'LL', 'IN', 'OUT'],
  DPR:  ['', 'SP', 'HI', 'LO', 'HL', 'LL'],
  FLW:  ['', 'SP', 'HI', 'LO', 'HL', 'LL'],
  LVL:  ['', 'SP', 'HI', 'LO', 'HL', 'LL'],
  HUM:  ['', 'SP', 'HI', 'LO', 'HL', 'LL'],
...
export const seedMedQtys: Record<string, string[]> = {
  ...
  SA:  ['TMP', 'HUM', 'CO2', 'ALM', 'DMP', 'DMO'],
  RA:  ['TMP', 'HUM', 'CO2', 'ALM', 'DMP', 'DMO'],
  OA:  ['TMP', 'HUM', 'CO2', 'DMP', 'DMO'],
  EX:  ['TMP', 'HUM', 'CO2', 'DMP', 'DMO'],
  RM:  ['TMP', 'HUM', 'CO2', 'ALM'],
  ZN:  ['TMP', 'HUM', 'CO2', 'ALM', 'DMP', 'DMO'],
  // Hydronic circuits
  CW:  ['TMP', 'STMP', 'RTMP', 'PRS', 'DPR', 'FSW', 'FLW', 'VLV', 'GLY', 'ALM'],
  HW:  ['TMP', 'STMP', 'RTMP', 'PRS', 'DPR', 'FSW', 'FLW', 'VLV', 'PSW', 'OHS'],
  ...
  SW:  ['TMP', 'PRS', 'FSW', 'FLW'],
  // Refrigerant / HVAC
  RF:  ['TMP', 'PRS', 'PSW', 'VLV', 'ALM'],
  EV:  ['TMP', 'PRS', 'PCT', 'ONO', 'ENB'],
  DF:  ['TMP', 'PRS', 'SWT', 'ONO'],
  CP:  ['TMP', 'PRS', 'PSW', 'STS', 'FLT', 'RUN'],
  // Medical / lab gases — GSB only
  MA:  ['PRS', 'PSW', 'ALM', 'FLW', 'FSW'],
  OX:  ['PRS', 'PSW', 'FLW', 'FSW', 'ALM'],
  NI:  ['PRS', 'PSW', 'FLW', 'FSW', 'ALM'],
  NO:  ['PRS', 'PSW', 'FLW', 'FSW', 'ALM'],
  AR:  ['PRS', 'PSW', 'FLW', 'FSW', 'ALM'],
  // Electrical
  EL:  ['CUR', 'PWA', 'PWF', 'PWR', 'KVA', 'VLN', 'VPH', 'FLT', 'ALM'],
  EN:  ['TMP', 'PRS', 'FLT', 'SPD', 'SWT', 'ENB', 'ALM', 'PSW'],
  // Fuel / oil / liquids
  ...
  AL:  ['FLT', 'TRP', 'FIR'],
  ES:  ['SWT'],
  IL:  ['SWT', 'FIR', 'OHS', 'FSW', 'PSW', 'LSW'],
  // Steam / speed / auto / manual / dirty filter
  ST:  ['TMP', 'PSW', 'PRS', 'DPR', 'ALM', 'OHS'],
  SP:  ['SPD', 'VSD'],
  MN:  ['SWT'],
  AU:  ['SWT'],
  FD:  ['SWT'],
...
export const seedEquipMeds: Record<string, string[]> = {
  ACP: ['EL', 'AR', 'OL', 'AL', 'CP', 'OA', ''],
  AHU: ['FA', 'SA', 'RA', 'OA', 'EX', 'CW', 'HW', 'SW', 'IL', 'SP', 'AU', 'MN', 'WA', 'AR', 'RM', 'ZN', 'FD'],
  AUT: ['SW', 'EL', 'WA', 'ST', ''],
  BSC: ['FU', 'SW', 'EL', 'ST', 'WA', 'AL', 'AR', 'OA', 'EX', 'SA', 'ES', ''],
  BSD: ['FU', 'OL', 'SW', 'EL', 'ST', 'WA', 'AR', 'SA', 'OA', 'EX', 'ES', 'HW', ''],
  BSE: ['EL', 'SW', 'ST', 'WA', 'AL', 'ES', ''],
  BSG: ['FU', 'SW', 'EL', 'ST', 'WA', 'AR', ''],
  BSR: ['EL', 'SW', 'ST', 'WA', 'AL'],
  BWC: ['FU', 'HW', 'EL', ''],
  BWD: ['FU', 'OL', 'HW', 'EL', 'OA', 'AR', 'OX', 'SW', 'RW', ''],
  BWE: ['EL', 'HW', ''],
  BWG: ['FU', 'HW', 'EL', 'SW', 'RW', 'ES', 'WA', 'IL', ''],
  BWR: ['EL', 'HW', ''],
  CHR: ['CW', 'CO', 'EV', 'RF', 'EL', 'GY', 'DF', 'HW', 'FA', 'CP', 'IL'],
  CTW: ['CO', 'OA', 'FA', 'SW', 'RW', 'AR'],
  CWP: ['SW', 'RW', 'WA', 'SP', 'ES', 'AL'],
  ECF: ['FA', 'SA', 'EX', 'AL', 'IL', ''],
  EXF: ['EX', 'FA'],
  ...
  HEX: ['CW', 'HW', 'CO', 'GY', 'AR', 'AL', 'ST'],
  HWP: ['WA', 'SW', 'RW', 'SP', 'ES', 'AL'],
  ILH: ['HW', 'EL', 'SW', 'RW', 'IL', 'WA', 'AL'],
  LFC: ['CW', 'HW', 'SA', 'RA', ''],
  MAU: ['FA', 'SA', 'OA', 'RA', 'CW', 'HW'],
  PMP: ['CW', 'HW', 'WA', 'CO', 'GY', 'IL', 'ES', 'SP', 'AU', 'MN'],
  RCR: ['RF', 'CP', 'EL', 'OL', ''],
  RFR: ['RF', 'CP', 'EL', 'OL', 'DF', ''],
  SAF: ['IL', 'ES', 'AL', ''],
  SXF: ['IL', 'AL', 'ES', ''],
  SYS: ['CW', 'HW', 'CO', 'GY', 'EL', 'WA', ''],
  TNK: ['CW', 'HW', 'WA', 'FU', 'OL', 'AL'],
  VAC: ['AR', 'EL', 'AL', ''],
  VFD: ['EL', 'FA', 'ES', 'AL', 'IL', ''],
  VRV: ['RF', 'SA', 'RA', 'ZN', 'CP', 'EV', 'DF', 'FA', 'HW', 'OA', 'SW', 'RW', 'EL', 'IL', 'AR'],
  HUM: ['WA', 'RA', 'AU', 'MN', 'IL', ''],
};
...
function makeVar(
  ...
  const baseMedLabel = medEntry?.label ?? '';
...
export const seedAssemblies: Assembly[] = [
...

  {
    ...
    points: [
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'FSW',  mod: '' },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'PRS',  mod: 'IN'  },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'PRS',  mod: 'OUT' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'VSD',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'STS',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FLT',  mod: '' },
    ],
  },
  {
    id: uuidv4(),
  ...
  },
  {
    ...
    points: [
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'FSW',  mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'PRS',  mod: 'IN'  },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'PRS',  mod: 'OUT' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'VSD',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'STS',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FLT',  mod: '' },
    ],
  ...
  },
  {
    ...
    points: [
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'FSW',  mod: '' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'PRS',  mod: 'IN'  },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'PRS',  mod: 'OUT' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'VSD',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'STS',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FLT',  mod: '' },
    ],
...

  {
    ...
    points: [
      { id: uuidv4(), med: '', medNum: '',   qty: 'STS',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FLT',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'ALM',  mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'STMP', mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'RTMP', mod: '' },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'STMP', mod: '' },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'RTMP', mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'DPR',  mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'FSW',  mod: '' },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'FSW',  mod: '' },
    ],
  },
...

  {
    ...
    points: [
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'STMP', mod: '' },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'RTMP', mod: '' },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'VLV',  mod: '' },
      { id: uuidv4(), med: 'CO', medNum: '', qty: 'DMP',  mod: '' },
      { id: uuidv4(), med: 'FA', medNum: '', qty: 'VSD',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'STS',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FLT',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'SWT',  mod: '' },
    ],
  },
...

  {
    ...
    points: [
      { id: uuidv4(), med: 'FA', medNum: '', qty: 'VSD',  mod: '' },
      { id: uuidv4(), med: 'FA', medNum: '', qty: 'STS',  mod: '' },
      { id: uuidv4(), med: 'FA', medNum: '', qty: 'FLT',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'SWT',  mod: '' },
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'TMP',  mod: '' },
      { id: uuidv4(), med: 'RA', medNum: '', qty: 'TMP',  mod: '' },
      { id: uuidv4(), med: 'SW', medNum: '', qty: 'TMP',  mod: '' },
      { id: uuidv4(), med: 'RA', medNum: '', qty: 'CO2',  mod: '' },
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'DPR',  mod: '' },
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'FSW',  mod: '' },
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'DPR',  mod: '1' },
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'DPR',  mod: '2' },
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'DPR',  mod: '3' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'VLV',  mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'DMP',  mod: '' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'VLV',  mod: '' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'DMP',  mod: '' },
      { id: uuidv4(), med: 'OA', medNum: '', qty: 'DMO',  mod: '' },
      { id: uuidv4(), med: 'OA', medNum: '', qty: 'DMP',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FIR',  mod: '' },
      { id: uuidv4(), med: 'FA', medNum: '', qty: 'VSD',  mod: '', ioOverride: 'AV' },
    ],
  },
  {
    id: uuidv4(),
    ...
    points: [
      ...
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'VLV',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FIR',  mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'PWA',  mod: '', ioOverride: 'AV' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'PWA',  mod: '', ioOverride: 'AV' },
      { id: uuidv4(), med: 'RA', medNum: '', qty: 'TMP',  mod: '', ioOverride: 'AV' },
      { id: uuidv4(), med: 'FA', medNum: '', qty: 'VSD',  mod: '', ioOverride: 'AV' },
    ],
  },
...

  {
    ...
    points: [
      ...
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'FSW',  mod: '' },
      { id: uuidv4(), med: 'SA', medNum: '', qty: 'DPR',  mod: '' },
      { id: uuidv4(), med: 'ZN', medNum: '', qty: 'TMP',  mod: '' },
      { id: uuidv4(), med: 'WA', medNum: '', qty: 'VLV',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'OHS',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FIR',  mod: '' },
    ],
  },
  {
    ...
    points: [
      ...
      { id: uuidv4(), med: 'ZN', medNum: '', qty: 'TMP',  mod: '' },
      { id: uuidv4(), med: 'WA', medNum: '', qty: 'VLV',  mod: '' },
      { id: uuidv4(), med: 'EL', medNum: '', qty: 'STG',  mod: '1' },
      { id: uuidv4(), med: 'EL', medNum: '', qty: 'STG',  mod: '2' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'OHS',  mod: '' },
      { id: uuidv4(), med: '', medNum: '',   qty: 'FIR',  mod: '' },
    ],
  },
...

  {
    ...
    points: [
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'FSW',  mod: '' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'TMP',  mod: 'IN'  },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'TMP',  mod: 'OUT' },
      { id: uuidv4(), med: 'EL', medNum: '', qty: 'STG',  mod: '1' },
      { id: uuidv4(), med: 'EL', medNum: '', qty: 'STG',  mod: '2' },
      { id: uuidv4(), med: 'EL', medNum: '', qty: 'STG',  mod: '3' },
    ],
  },
  {
    id: uuidv4(),
    ...
    points: [
      { id: uuidv4(), med: '', medNum: '', qty: 'TMP', mod: 'T' },
      { id: uuidv4(), med: '', medNum: '', qty: 'TMP', mod: 'M' },
      { id: uuidv4(), med: '', medNum: '', qty: 'TMP', mod: 'B' },
    ],
  },
  {
    id: uuidv4(),
    ...
    points: [
      { id: uuidv4(), med: '', medNum: '', qty: 'RUN', mod: '' },
      { id: uuidv4(), med: '', medNum: '', qty: 'ENB', mod: '' },
      { id: uuidv4(), med: '', medNum: '', qty: 'FLT', mod: '' },
      { id: uuidv4(), med: '', medNum: '', qty: 'VSD', mod: '' },
      { id: uuidv4(), med: '', medNum: '', qty: 'FSW', mod: '' },
    ],
  },
  {
    id: uuidv4(),
    ...
    points: [
      ...
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'RTMP', mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'DPR',  mod: '' },
      { id: uuidv4(), med: 'CW', medNum: '', qty: 'DPR',  mod: 'SP' },
    ],
  },
  {
    id: uuidv4(),
    ...
    points: [
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'STMP', mod: '' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'RTMP', mod: '' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'DPR',  mod: '' },
      { id: uuidv4(), med: 'HW', medNum: '', qty: 'DPR',  mod: 'SP' },
    ],
  },
];
